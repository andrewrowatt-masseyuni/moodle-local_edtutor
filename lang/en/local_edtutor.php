...
$string['assessmenthidden'] = 'The assessment has been hidden.';
$string['assessmentshown'] = 'The assessment is now shown.';
$string['backtotutorarea'] = 'Back to the tutor area';
$string['bycourse'] = 'By course';
$string['bystudent'] = 'By student';
$string['cannotsubmitonbehalf'] = 'Cannot submit on behalf for this activity type';
...
$string['dashboard'] = 'Education Tutor dashboard';
$string['dashboardmenu'] = 'Education Tutor dashboard';
$string['digestupdated'] = 'Email digest type updated for {$a}';
$string['dueon'] = 'Due {$a}';
...
$string['edtutor:setpreferences'] = 'Set forum preferences for allocated students';
...
$string['edtutorrole_desc'] = 'Education tutors can submit assignments and set forum preferences on behalf of the students allocated to them.';
$string['emaildigestfor'] = 'Email digest type for {$a}';
$string['error:alreadycompleted'] = 'This submission has already been completed.';
$string['error:alreadyloggedinas'] = 'You are already logged in as another user. Log out to return to your own account first.';
...
$string['error:notescalated'] = 'Only submissions awaiting manual completion can be marked as completed.';
...
$string['filterallcourses'] = 'Show all courses';
$string['filterallstudents'] = 'Show all students';
$string['gotoassignment'] = 'Go to the assignment';
$string['hideassessment'] = 'Hide assessment';
$string['hideassessmentconfirm'] = 'Are you sure you want to hide "{$a->activity}" in {$a->course} for {$a->student}?';
$string['hideassessmentwarning'] = 'Hidden assessments no longer appear on your dashboard for this student. Use this for overdue assessments that will never be submitted. To see them again, choose "Show only hidden assessments" in the Status filter.';
...
$string['loginonbehalf'] = 'Login on behalf';
...
$string['noactivities'] = 'No assignments or quizzes.';
...
$string['nocourses'] = 'Not enrolled in any courses.';
$string['nocoursesforstudent'] = 'The selected student is not enrolled in any courses.';
$string['nocourseswithstudents'] = 'None of your allocated students are enrolled in a course yet.';
$string['noduedateheading'] = 'The following activities have no due date set';
$string['nofiles'] = 'No files were uploaded.';
$string['nomatchingitems'] = 'Nothing matches the current filters.';
...
$string['privacy:metadata:local_edtutor_hidden'] = 'Assessments a tutor has hidden for a student on their dashboard.';
$string['privacy:metadata:local_edtutor_hidden:studentid'] = 'The user id of the student the assessment is hidden for.';
$string['privacy:metadata:local_edtutor_hidden:tutorid'] = 'The user id of the tutor who hid the assessment.';
...
$string['privacy:metadata:preference:local_edtutor_dashboard_timeframe'] = 'The dashboard status filter (show all, overdue or upcoming, overdue only, or hidden assessments only) last chosen by the user.';
$string['privacy:metadata:preference:local_edtutor_dashboard_view'] = 'The dashboard layout (by student or by course) last chosen by the user.';
...
$string['returntomyaccount'] = 'Log out and return to my account';
$string['selectassignment'] = 'Assignment';
$string['selectcourse'] = 'Course';
$string['selectstudent'] = 'Student';
$string['setstudentpreferences'] = 'Set student preferences';
$string['settings:roleshortname'] = 'Education tutor role shortname';
$string['settings:roleshortname_desc'] = 'Shortname of the system role used to identify education tutors. This role needs local/edtutor:submit, local/edtutor:loginas, local/edtutor:setpreferences, mod/assign:editothersubmission and moodle/site:viewuseridentity set to Allow. The plugin creates a suitable "Education tutor" role (shortname edtutor) when it is installed.';
...
$string['settings:upcomingdays'] = 'Upcoming assessment window (days)';
$string['settings:upcomingdays_desc'] = 'Number of days ahead within which an unsubmitted assessment counts as upcoming for the dashboard "Show only overdue or upcoming assessments" filter.';
...
$string['studentpreferences'] = 'Student forum preferences';
$string['studentpreferences_desc'] = 'Set the forum email digest type for each of your allocated students. Changes are saved immediately.';
$string['studentpreferencesmenu'] = 'Set student forum preferences';
...
$string['submitas'] = 'Submit';
$string['submitonbehalf'] = 'Submit on behalf of student';
$string['submitonbehalfaction'] = 'Submit on behalf';
$string['submitted'] = 'Submitted';
$string['submittedfiles'] = 'Submitted files';
$string['target'] = 'Target assignment';
$string['timeframeall'] = 'Show all';
$string['timeframeduesoon'] = 'Show only overdue or upcoming assessments';
$string['timeframehidden'] = 'Show only hidden assessments';
$string['timeframeoverdue'] = 'Show only overdue';
$string['tutor'] = 'Tutor';
