...
$string['privacy:metadata:preference:local_edtutor_dashboard_timeframe'] = 'The dashboard timeframe filter (show all, overdue or upcoming, or overdue only) last chosen by the user.';
