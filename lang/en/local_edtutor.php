...
$string['edtutormanagerrole_desc'] = 'Education tutor managers can manage which students are allocated to each education tutor.';
...
$string['error:cannotprocess'] = 'You do not have permission to process submissions.';
...
$string['settings:roleshortname_desc'] = 'Shortname of the system role used to identify education tutors. This role needs local/edtutor:submit, mod/assign:editothersubmission and moodle/site:viewuseridentity set to Allow. The plugin creates a suitable "Education tutor" role (shortname edtutor) when it is installed.';
...
$string['settings:supportstaff_desc'] = 'Usernames of the staff who are notified when a submission must be completed manually, one per line. These users can also open the submission queue. Managers (users with the process submissions capability) always have access.';
